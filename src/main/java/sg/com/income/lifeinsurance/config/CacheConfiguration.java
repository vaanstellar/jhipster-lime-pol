package sg.com.income.lifeinsurance.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("limePolicyService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("limePolicyService");
        ...
        config.getMapConfigs().put("sg.com.income.lifeinsurance.domain.*", initializeDomainMapConfig(jHipsterProperties));
